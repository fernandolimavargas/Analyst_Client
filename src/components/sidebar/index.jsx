...
const Sidebar = () => {
  ...
  return (
    <Fragment>
          ...
          <div className="offcanvas offcanvas-start modal-div" id="bugreport">
            ...
            <div className="offcanvas-header bug-header">
              <div className="d-flex justify-content-between">
                ...
                <h6 className="offcanvas-title title-bug" id="bugreportLabel">
            ...
            <div className="offcanvas-body bug-body">
              <form className="form" onSubmit={submitSolBug}>
                <div className="mb-3">
                  <label className="form-label" htmlFor="systemDoing">
                ...
                <div className="mb-3">
                  <label className="form-label" htmlFor="shouldDo">
                    Como deveria fazer?
                  </label>
                  <textarea
                    className="form-control"
                ...
                <div className="d-flex flex-row justify-content-center">
                  <div className="mb-3 form-check me-3">
                    ...
                    />
                    <label className="form-check-label" htmlFor="improvement">
                      Melhoria
                    </label>
                  </div>
                  <div className="mb-3 form-check me-3">
                ...
                <div className="text-center">
                  <button className="btn btn-secondary btn_send_bug mt-3" type="submit">
                    Enviar Solicitação
                  </button>
                </div>
              </form>
      ...
      <div
        className="offcanvas offcanvas-start modal-div"
        id="menusidebar"
      ...
      >
        <div className="offcanvas-header">
          <div className="d-flex justify-content-between">
            <img src={iconlogo} alt="" />
            <h6 className="offcanvas-title ms-2" id="menusidebarLabel">
              Linx DMS Help
            </h6>
          </div>
          <AiOutlineClose
          ...
          <div className="menu">
            <li className="item" id="mn1" onClick={() => showToHideSubmenu('mn1')}>
              ...
              <div className="submenu">
                <a onClick={() => navigate('/request/listing/Error')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Erros
                </a>
                <a
                  onClick={() => navigate('/request/listing/Alteration')}
                  data-bs-dismiss="offcanvas"
                >
                  <AiFillCaretRight /> Alterações
                </a>
                <a
                  onClick={() => navigate('/request/listing/Customization')}
                  data-bs-dismiss="offcanvas"
                >
                  <AiFillCaretRight /> Customizações
                </a>
                <a onClick={() => navigate('/request/listing/Script')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Scripts
                </a>
                <a onClick={() => navigate('/request/listing/Service')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Serviços
                </a>
                <a onClick={() => navigate('/request/listing/Import')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Importações
                </a>
                <a onClick={() => navigate('/request/listing/Share')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Shares
                </a>
                <a onClick={() => navigate('/request/listing/Ticket')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Tickets
                </a>
                <a
                  onClick={() => navigate('/request/listing/InternalIssue')}
                  data-bs-dismiss="offcanvas"
                >
                  <AiFillCaretRight /> ISSUE Internas
                </a>
                <a onClick={() => navigate('/request/listing/Help')} data-bs-dismiss="offcanvas">
            ...
            <li className="item" id="mn2" onClick={() => showToHideSubmenu('mn2')}>
              ...
              <div className="submenu">
                <a
                  onClick={() => navigate('/management/ServiceSearch')}
                  data-bs-dismiss="offcanvas"
                >
                  <AiFillCaretRight /> Consulta de atendimentos
                </a>
                <a onClick={() => navigate('/management/CallSearch')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Consulta de chamados
                </a>
                <a
                  onClick={() => navigate('/management/ServiceReport')}
                  data-bs-dismiss="offcanvas"
                >
                  <AiFillCaretRight /> Relatorio de atendimento
                </a>
                <a
                  onClick={() => navigate('/management/AnalystPerformance')}
                  data-bs-dismiss="offcanvas"
                >
            ...
            <li className="item" id="mn3" onClick={() => showToHideSubmenu('mn3')}>
              ...
              <div className="submenu">
                <a href="#">
                  <AiFillCaretRight /> Limpeza de Arquivos Temporarios
                </a>
                <a href="#">
                  <AiFillCaretRight /> Criação/Atualização de ambiente
                </a>
              </div>
            </li>
            <li className="item" id="mn4" onClick={() => showToHideSubmenu('mn4')}>
              ...
              <div className="submenu">
                <a onClick={() => navigate('/registration/User')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Usuários
                </a>
                <a onClick={() => navigate('/registration/Team')} data-bs-dismiss="offcanvas">
                  <AiFillCaretRight /> Times
                </a>
                <a onClick={() => navigate('/registration/Database')} data-bs-dismiss="offcanvas">
            ...
            <li className="item" id="mn5" onClick={() => showToHideSubmenu('mn5')}>
              ...
              <div className="submenu">
                <a href="https://wf.linx.com.br/" target="_blank">
                  <AiFillCaretRight /> WorkFlow
                </a>
                <a href="https://share.linx.com.br/login.action?os_destination=%2F" target="_blank">
                  <AiFillCaretRight /> LinxShare
                </a>
                <a href="https://jira.linx.com.br/secure/Dashboard.jspa" target="_blank">
                  <AiFillCaretRight /> JiraLinx
                </a>
                <a href="http://apollo-app03.eastus.cloudapp.azure.com:81/" target="_blank">
                  <AiFillCaretRight /> Dicionario
                </a>
                <a
                  href="https://share.linx.com.br/pages/viewpage.action?pageId=304502307"
                  target="_blank"
                >
                  <AiFillCaretRight /> DVI-Share
                </a>
                <a href="http://linxnfse.linx.com.br/portalcross/login.xhtml" target="_blank">
                  <AiFillCaretRight /> Portal Cross
                </a>
                <a href="http://192.168.45.4:8080/interact_multiagent/" target="_blank">
                  <AiFillCaretRight /> Interact Multiagent
                </a>
                <a href="https://suporte.ccmtecnologia.com.br/portal/pt/signin" target="_blank">
                  <AiFillCaretRight /> CCM
                </a>
                <a href="http://192.168.45.4:8080/interact_manager/" target="_blank">
                  <AiFillCaretRight /> Interact Manager
                </a>
                <a href="https://linx.deskbee.app/app/home" target="_blank">
