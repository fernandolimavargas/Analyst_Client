        ...
        <div className="container-fluid">
            <div className="row"> 
                <div className="div-lside col-3">
                    ...
                    <p _ngcontent-rgy-c10="" className="copyright"> © Linx - Todos direitos reservados </p>
                </div>
                        ...
                        <form className="form" onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3 form-check">
                                <input className="form-check-input" 
                                    ...
                                    />
                                <label className="form-check-label" htmlFor="">Lembrar meu login</label>
                            </div>
                            <button className="btn btn-secondary btn_login" type="submit" onClick={handleSubmit}>Conectar</button>
                        </form> 
                    </div>
                    <a type="button" className="helplogin" data-bs-toggle="modal" data-bs-target="#nologed" data-bs-whatever="@mdo">Não consegue logar?</a>
                </div>
            </div>
            <div className="modal fade" id="nologed" tabIndex="-1" aria-labelledby="nologedLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="nologedLabel">Não consegue logar?</h5>
                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="email" 
                                    className="form-control" 
                                    id="recipient-name" value={forgetEmail} 
                                ...
                                <button type="button" 
                                    ...
                                    onClick={handleAccess}>Solicitar acesso</button>
                                    <button type="button" 
                                        className="btn btn-secondary" 
                                        data-bs-dismiss="modal"
                                        onClick={handleForget}>Resetar senha</button>
                                </div>
                            </form>
                        </div>
