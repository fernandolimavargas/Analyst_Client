...
//helpers rotes
import HelperListingError from './pages/requests/helpersListings/error';

import React, { useContext } from 'react';

import { AuthContext, AuthProvider } from './contexts/auth';
import PublishSol from './pages/requests/helpersListings/error/publish';
    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          />
          <Route
            path="/request/helper/error/publish"
            element={
              <Private>
                <PublishSol />
              </Private>
